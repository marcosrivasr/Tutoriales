...
(function () {
	...
	var num_replies = '0,0,0,0,0,2,0,0,0,0,0,1,0'.split(',');
	var num_reactions = '3,1,0,0,1,0,1,3,0,0,1,8,0' ? '3,1,0,0,1,0,1,3,0,0,1,8,0'.split(',') : '';
	...
	for (i = 0; i < disqus_nodes.length; i++) {
		...
		if (replies_count !== undefined && !isNaN(replies_count)) {
			if (replies_count > 1) {
				...
				link_text += 'Comentar'.replace('{num}', replies_count);
			}
		}
